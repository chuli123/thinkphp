...
<body>
	...
	<div class="left">
		<div class="div1">
			<div class="left_top">
				<img src="/Public/images/bbb_01.jpg"><img src="/Public/images/bbb_02.jpg"
					id="2"><img src="/Public/images/bbb_03.jpg"><img
					src="/Public/images/bbb_04.jpg">
			</div>
           ...
           <div class="div2">
			...
			<div class="div3">
				<li><a class="a" href="javascript:void(0);"
					onClick="openurl('<?php echo U('Home/Index/setgl');?>');">网站基本配置</a></li>		   
			</div>
			<div class="div2">
				<div class="spgl"></div>
				资料管理
			...
			<div class="div3">
				<ul>
					<li><a class="a" href="javascript:void(0);"
						onClick="openurl('<?php echo U('Home/DataCat/index');?>');">资料分类管理</a></li>
						<li><a class="a" href="javascript:void(0);"
						onClick="openurl('<?php echo U('Home/DataCon/index');?>');">资料内容管理</a></li>
